...
const Dashboard = () => {
  ...
  const [assignedShifts, setAssignedShifts] = useState([
    { id: 1, date: '2025-04-15', time: '09:00-12:00', location: 'Ahmedabad', task: 'Service' },
    { id: 2, date: '2025-04-20', time: '13:00-17:00', location: 'Patna', task: 'Bar Logistics' },
    { id: 3, date: '2025-05-17', time: '10:00-14:00', location: 'Diu', task: 'Tambola-Tickets' },
    { id: 4, date: '2025-06-10', time: '14:00-18:00', location: 'Agartala', task: 'Cloakroam' }
  ]);

  // Mocked completed shifts for testing
  const [completedShifts, setCompletedShifts] = useState([
    { id: 1, date: '2025-02-10', time: '09:00-12:00', location: 'Bikaner', task: 'Cinema support', rating: 0, comment: '' },
    { id: 2, date: '2025-03-12', time: '14:00-17:00', location: 'Jaipur', task: 'Ushering Guests', rating: 0, comment: '' }
  ]);
...
// };
  ...
  const applyForShift = async (shiftId) => {
    try {
      ...
      const data = await response.json();
      if (response.ok) {
        // Find the applied shift from available shifts
        const appliedShift = shifts.find(shift => shift.id === shiftId);
  
        if (appliedShift) {
          // Move the shift from "Available Shifts" to "Assigned Shifts"
          setAssignedShifts(prevAssigned => [...prevAssigned, appliedShift]);
  ...
  const handleSubmitFeedback = (shiftId) => {
    ...
    if (shift) {
      ...
      setCompletedShifts(prevShifts => prevShifts.filter(shift => shift.id !== shiftId));
    }
  };
    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-container">
        ...
        <div className="profile-section">
          ...
          <p><strong>Name:</strong> Kritik Sharma</p>
          <p><strong>Total Hours Volunteered:</strong> 12 hours</p>
          <p><strong>Upcoming Shifts:</strong></p>
          <ul>
            <li>
              <strong>Date:</strong> 2025-04-15<br />
              <strong>Location:</strong> Kalyani, West Bengal<br />
              <strong>Location Manager:</strong> Raju Rastogi<br />
              <strong>Contact Number:</strong> +91 7912394567
            </li>
          </ul>
